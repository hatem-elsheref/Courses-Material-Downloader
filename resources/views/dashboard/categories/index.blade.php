                    ...
                    <div class="box-body table-responsive no-padding">
                        <table class="table table-hover">
                            <tbody><tr>
                                ...
                                <th>Category Name</th>
                                <th>Category Slug</th>
                                <th>Courses Under This Category</th>
                            ...
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('category.show',$category->id)}}" class="btn btn-sm btn-warning"><i class="fa fa-eye"></i>  View Courses </a>
                                    </td>
                                    <form action="{{route('category.destroy',$category->id)}}" id="item-{{$category->id}}" method="POST"> @csrf @method('DELETE') </form>
                                </tr>
                            @endforeach
                            </tbody></table>
                    </div>
