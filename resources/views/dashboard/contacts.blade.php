                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($contacts as $contact)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm btn-success" href="{{route('contacts.update',$contact->id)}}"> <i class="fa fa-check"></i> Change The Status  </a>
                                    ...
                                    <form action="{{route('contacts.destroy',$contact->id)}}" id="item-remove-{{$contact->id}}" method="POST">@csrf @method('DELETE') </form>
