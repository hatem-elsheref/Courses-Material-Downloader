                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <img src="{{asset('default-user.png')}}" class="user-image" alt="User Image">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="{{asset('default-user.png')}}" class="img-circle" alt="User Image" style="width: 40px;height: 40px">
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="{{asset('default-user.png')}}" class="img-circle" alt="User Image" style="40px;height: 40px">
                </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="{{inTheCurrentRoute('dashboard')}}"><a href="{{route('dashboard')}}"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
                 ...
                 @if(auth()->user()->role == MANAGER )
                    <li class="{{inTheCurrentRoute('admins')}}"><a href="{{route('admins')}}"><i class="fa fa-user-secret"></i> <span>Admins</span></a></li>
               @endif
                    <li class="{{inTheCurrentRoute('users')}}"><a href="{{route('users')}}"><i class="fa fa-user"></i> <span>Users</span></a></li>
                    <li class="{{inTheCurrentRoute('category/*','category')}}"><a href="{{route('category.index')}}"><i class="fa fa-cubes"></i> <span>Categories</span></a></li>
                    <li class="{{inTheCurrentRoute('instructor/*','instructor')}}"><a href="{{route('instructor.index')}}"><i class="fa fa-user-circle"></i> <span>Instructors</span></a></li>
                    <li class="{{inTheCurrentRoute('course/*','course')}}"><a href="{{route('course.index')}}"><i class="fa fa-graduation-cap"></i> <span>Courses</span></a></li>
                    <li class="{{inTheCurrentRoute('material/*')}}"><a href="{{route('course.index')}}"><i class="fa fa-file-archive-o"></i> <span>Materials</span></a></li>
                    <li class="{{inTheCurrentRoute('contacts.show')}}"><a href="{{route('contacts.show')}}"><i class="fa fa-support"></i> <span>Contacts</span></a></li>
            </ul>
            <!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
